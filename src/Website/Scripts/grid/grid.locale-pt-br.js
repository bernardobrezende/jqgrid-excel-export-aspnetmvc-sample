...
$.jgrid = {
	...
	search : {
	    ...
	    Find: "Procurar",
	    Reset: "Resetar",
	    odata : ['igual', 'não igual', 'menor que', 'menor ou igual','maior que','maior ou igual', 'começa com','não começa com','está em','não está em','termina com','não termina com','contém','não contém'],
